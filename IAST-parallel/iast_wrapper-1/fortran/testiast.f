...
C     Start for Python1
      ...
      Pow(4, 2) = 1.0d0 
      Pow(4, 1) = 1.0d0 
      Nimax(4, 2) = 0.240380d0 
      Nimax(4, 1) = 0.452291d0 
      Ki(4, 2) = 0.00003198604d0 
      Ki(4, 1) = 0.00003198627d0 
      Yi(3) =  0.15d0 
      Langmuir(3, 2) = .True. 
      Langmuir(3, 1) = .True. 
      Pow(3, 2) = 1.0d0 
      Pow(3, 1) = 1.0d0 
      Nimax(3, 2) = 1898.100590d0 
      Nimax(3, 1) = 0.690653d0 
      Ki(3, 2) = 0.00000000000d0 
      Ki(3, 1) = 0.00001355027d0 
      Yi(2) =  0.20d0 
      Langmuir(2, 2) = .True. 
      Langmuir(2, 1) = .True. 
      Pow(2, 2) = 1.0d0 
...
C     Start for Python2
      write(25,'(A)') "  Pressure (Pa) @ 550K 22mC4 (mol/kg) 24mC5 (mol/kg) 2mC5 (mol/kg) 2mC6 (mol/kg) 3mC5 (mol/kg)" 
