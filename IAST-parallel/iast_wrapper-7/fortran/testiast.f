...
C     Start for Python1
      ...
      Pow(5, 2) = 1.0d0 
      Pow(5, 1) = 1.0d0 
      Nimax(5, 2) = 0.685645d0 
      Nimax(5, 1) = 21343.033200d0 
      Ki(5, 2) = 0.00000818449d0 
      Ki(5, 1) = 0.00000000000d0 
      Yi(4) =  0.10d0 
      Langmuir(4, 2) = .True. 
      Langmuir(4, 1) = .True. 
      Pow(4, 2) = 1.0d0 
      ...
      Pow(2, 2) = 1.0d0 
      Pow(2, 1) = 1.0d0 
      Nimax(2, 2) = 1898.100590d0 
      Nimax(2, 1) = 0.690653d0 
      Ki(2, 2) = 0.00000000000d0 
      Ki(2, 1) = 0.00001355027d0 
      Yi(1) =  0.50d0 
      Langmuir(1, 2) = .True. 
      Langmuir(1, 1) = .True. 
      Pow(1, 2) = 1.0d0 
      Pow(1, 1) = 1.0d0 
      Nimax(1, 2) = 0.656622d0 
      Nimax(1, 1) = 1559.739140d0 
      Ki(1, 2) = 0.00000268848d0 
      Ki(1, 1) = 0.00000000000d0 
C     End for Python1
...
C     Start for Python2
      write(25,'(A)') "  Pressure (Pa) @ 550K 24mC5 (mol/kg) 2mC5 (mol/kg) 2mC6 (mol/kg) 3eC5 (mol/kg) 3mC5 (mol/kg)" 
