...
C     Start for Python1
      ...
      Pow(3, 2) = 1.0d0 
      Pow(3, 1) = 1.0d0 
      Nimax(3, 2) = 0.681315d0 
      Nimax(3, 1) = 1.002204d0 
      Ki(3, 2) = 0.00274614593d0 
      Ki(3, 1) = 0.00000000087d0 
      Yi(2) =  0.15d0 
      Langmuir(2, 2) = .True. 
      Langmuir(2, 1) = .True. 
      Pow(2, 2) = 1.0d0 
      Pow(2, 1) = 1.0d0 
      Nimax(2, 2) = 0.249054d0 
      Nimax(2, 1) = 0.445821d0 
      Ki(2, 2) = 0.00188345000d0 
      Ki(2, 1) = 0.00188345000d0 
      Yi(1) =  0.70d0 
      Langmuir(1, 2) = .True. 
      Langmuir(1, 1) = .True. 
      Pow(1, 2) = 1.0d0 
      Pow(1, 1) = 1.0d0 
      Nimax(1, 2) = 0.815591d0 
      Nimax(1, 1) = 0.680083d0 
      Ki(1, 2) = 0.00000000305d0 
      Ki(1, 1) = 0.01566807000d0 
C     End for Python1
...
C     Start for Python2
      write(25,'(A)')   "     Pressure (Pa)     3mC6-400 (mol/kg)     33mC5-400 (mol/kg)     23mC5-400 (mol/kg)     C7-400 (mol/kg)" 
