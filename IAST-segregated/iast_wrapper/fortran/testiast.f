...
C     Start for Python
      ...
      Pow(1, 2) = 1.0d0 
      Pow(1, 1) = 1.0d0 
      Nimax(2, 2) = 1.002204d0 
      Nimax(2, 1) = 0.681315d0 
      Ki(2, 2) = 0.00000000087d0 
      Ki(2, 1) = 0.00274614485d0 
      Nimax(1, 2) = 1.054842d0 
      Nimax(1, 1) = 0.678300d0 
      Ki(1, 2) = 0.00000000080d0 
      Ki(1, 1) = 0.01047262013d0 
      Yi(1) = 1.00d0      
      Yi(2) = 0.00d0      
C     End for Python
