...
C     Start for Python
      ...
      Pow(1, 2) = 1.0d0 
      Pow(1, 1) = 1.0d0 
      Nimax(2, 2) = 1.247232d0 
      Nimax(2, 1) = 0.667097d0 
      Ki(2, 2) = 0.00000000142d0 
      Ki(2, 1) = 0.00015623026d0 
      Nimax(1, 2) = 0.629256d0 
      Nimax(1, 1) = 0.065357d0 
      Ki(1, 2) = 0.00018169109d0 
      Ki(1, 1) = 0.00018168976d0 
      Yi(1) = 1.00d0      
      Yi(2) = 0.00d0      
C     End for Python
