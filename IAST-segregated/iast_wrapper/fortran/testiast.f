...
C     Start for Python1
      ...
      Pow(6, 2) = 1.0d0 
      Pow(6, 1) = 1.0d0 
      Nimax(6, 2) = 0.483846d0 
      Nimax(6, 1) = 0.686442d0 
      Ki(6, 2) = 0.00001472505d0 
      Ki(6, 1) = 0.05036542620d0 
      Yi(5) =  0.20d0 
      Langmuir(5, 2) = .True. 
      Langmuir(5, 1) = .True. 
      Pow(5, 2) = 1.0d0 
...
C     Start for Python2
      write(25,'(A)') "  Pressure (Pa) 22mC5-400 (mol/kg) 2mC6-400 (mol/kg) 3mC6-400 (mol/kg) 33mC5-400 (mol/kg) 23mC5-400 (mol/kg) C7-400 (mol/kg)" 
      write(6,'(2e20.10)') Ni(1),Ni(2),Ni(3),Ni(4),Ni(5),Ni(6)
      write(6,*) 'Ni(1)   ','Ni(2)   ','Ni(3)   ','Ni(4)   ','Ni(5)   ','Ni(6)   '
C     End for Python2
C      stop
      ...
      Do J = 0, 8
         If(J.Lt.8) Then
            Do I = 1, 50, 2
               ...
               Call Seg_Iast(Ni,Xi1,Molfrac,Yi,P,Nterm_max,Carrier_gas)
C     Start for Python3
                Write(25,'(20e20.10)') P,Ni(1),Ni(2),Ni(3),Ni(4),Ni(5),Ni(6)
            Enddo
         Else
            P = Dble(1.0*10**J)
            Call Seg_Iast(Ni,Xi1,Molfrac,Yi,P,Nterm_max,Carrier_gas)
