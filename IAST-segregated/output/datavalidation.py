...
importpath2 = "22mC5-500_23mC5-500/"

data1 = np.loadtxt(importpath1 + "C7-500-0.02_3mC6-500-0.98.txt", skiprows=1)
data2 = np.loadtxt(importpath1 + "C7-500-0.84_3mC6-500-0.16.txt", skiprows=1)
data3 = np.loadtxt(importpath1 + "C7-500-0.51_3mC6-500-0.49.txt", skiprows=1)
